 ...
 */ !function(e, t) {
    ...
    function h1(e4, t2, n) {
        if (n.__li = t2, n.__gui = e4, S.extend(n, {
            options: function(t) {
                if (arguments.length > 1) {
                    var o = n.__li.nextElementSibling;
                    return n.remove(), f1(e4, n.object, n.property, {
                        before: o,
                        factoryArgs: [
                            S.toArray(arguments)
                        ]
            ...
            var o2 = new Q(n.object, n.property, {
                min: n.__min,
                max: n.__max,
                step: n.__step
            });
            S.each([
                ...
                n[e5] = o2[e5] = function() {
                    ...
                    return i.apply(o2, e), t.apply(n, e);
                };
            }), X.addClass(t2, "has-slider"), n.domElement.insertBefore(o2.domElement, n.domElement.firstElementChild);
            ...
            var i2 = function(t) {
                if (S.isNumber(n.__min) && S.isNumber(n.__max)) {
                    ...
                    n.remove();
                    var r = f1(e4, n.object, n.property, {
            ...
            n.min = S.compose(i2, n.min), n.max = S.compose(i2, n.max);
        } else n instanceof K ? (X.bind(t2, "click", function() {
            X.fakeEvent(n.__checkbox, "click");
        }), X.bind(n.__checkbox, "click", function(e) {
            e.stopPropagation();
        })) : n instanceof Z ? (X.bind(t2, "click", function() {
        ...
        })) : n instanceof $ && (X.addClass(t2, "color"), n.updateDisplay = S.compose(function(e) {
            return t2.style.borderLeftColor = n.__color.toString(), e;
        }, n.updateDisplay), n.updateDisplay());
        n.setValue = S.compose(function(t) {
            return e4.getRoot().__preset_select && n.isModified() && _1(e4.getRoot(), !0), t;
        }, n.setValue);
    }
    function p1(e, t) {
    ...
    function f1(e, t, n, o) {
        ...
        if (o.color) i = new $(t, n);
            ...
            var r = [
                t,
                n
            ].concat(o.factoryArgs);
            i = ne.apply(e, r);
        }
        o.before instanceof z && (o.before = o.before.__li), p1(e, i), X.addClass(i.domElement, "c");
        var s = document.createElement("span");
        X.addClass(s, "property-name"), s.innerHTML = i.property;
        var a = document.createElement("div");
        a.appendChild(s), a.appendChild(i.domElement);
        var l = c1(e, a, o.before);
        return X.addClass(l, he.CLASS_CONTROLLER_ROW), i instanceof $ ? X.addClass(l, "color") : X.addClass(l, H(i.getValue())), h1(e, l, i), e.__controllers.push(i), i;
    }
    function m(e, t) {
    ...
    function v(e6) {
        var t3 = e6.__save_row = document.createElement("li");
        X.addClass(e6.domElement, "has-save"), e6.__ul.insertBefore(t3, e6.__ul.firstChild), X.addClass(t3, "save-row");
        ...
        var s = e6.__preset_select = document.createElement("select");
        if (e6.load && e6.load.remembered ? S.each(e6.load.remembered, function(t, n) {
            g(e6, n, n === e6.preset);
        }) : g(e6, se, !1), X.bind(s, "change", function() {
            for(var t = 0; t < e6.__preset_select.length; t++)e6.__preset_select[t].innerHTML = e6.__preset_select[t].value;
            e6.preset = this.value;
        }), t3.appendChild(s), t3.appendChild(n2), t3.appendChild(o), t3.appendChild(i), t3.appendChild(r), ae) {
            var a = document.getElementById("dg-local-explain"), l = document.getElementById("dg-local-storage");
            document.getElementById("dg-save-locally").style.display = "block", "true" === localStorage.getItem(m(e6, "isLocal")) && l.setAttribute("checked", "checked"), b(e6, a), X.bind(l, "change", function() {
                e6.useLocalStorage = !e6.useLocalStorage, b(e6, a);
            });
        }
        ...
        X.bind(d, "keydown", function(e) {
            ...
            d.innerHTML = JSON.stringify(e6.getSaveObject(), void 0, 2), le.show(), d.focus(), d.select();
    ...
    function y(e) {
        ...
        function n() {
            X.removeClass(e.__closeButton, he.CLASS_DRAG), X.unbind(window, "mousemove", t4), X.unbind(window, "mouseup", n);
        }
        function o3(o) {
            return o.preventDefault(), i = o.clientX, X.addClass(e.__closeButton, he.CLASS_DRAG), X.bind(window, "mousemove", t4), X.bind(window, "mouseup", n), !1;
        }
        var i = void 0;
        e.__resize_handle = document.createElement("div"), S.extend(e.__resize_handle.style, {
            ...
            cursor: "ew-resize",
            position: "absolute"
        }), X.bind(e.__resize_handle, "mousedown", o3), X.bind(e.__closeButton, "mousedown", o3), e.domElement.insertBefore(e.__resize_handle, e.domElement.firstElementChild);
    }
    function w(e, t) {
    ...
    function x(e7, t) {
        var n3 = {};
        return S.each(e7.__rememberedObjects, function(o, i) {
            var r = {}, s = e7.__rememberedObjectIndecesToControllers[i];
    ...
    function C(e8) {
        0 !== e8.length && oe.call(window, function() {
            C(e8);
        }), S.each(e8, function(e) {
            e.updateDisplay();
        });
    }
    var A = Array.prototype.forEach, k = Array.prototype.slice, S = {
        ...
        compose: function() {
            ...
            return function() {
                for(var t = k.call(arguments), n = e.length - 1; n >= 0; n--)t = [
                    e[n].apply(this, t)
                ];
                return t[0];
            };
        ...
        return S.each(O, function(t5) {
            if (t5.litmus(e)) return S.each(t5.conversions, function(t, n) {
                if (T = t.read(e), !1 === L && !1 !== T) return L = T, T.conversionName = n, T.conversion = t, S.BREAK;
            }), S.BREAK;
        }), L;
    }, B = void 0, N = {
        hsv_to_rgb: function(e, t, n) {
            var o = Math.floor(e / 60) % 6, i = e / 60 - Math.floor(e / 60), r = n * (1 - t), s = n * (1 - i * t), a = n * (1 - (1 - i) * t), l = [
                [
                    n,
                    a,
                    r
    ...
    I.recalculateRGB = function(e, t, n) {
        ...
        "hex",
        "a"
    ], n1(I.prototype, "r", 2), n1(I.prototype, "g", 1), n1(I.prototype, "b", 0), o1(I.prototype, "h"), o1(I.prototype, "s"), o1(I.prototype, "v"), Object.defineProperty(I.prototype, "a", {
        get: function() {
        ...
        get: function() {
            return this.__state.space, this.__state.hex = N.rgb_to_hex(this.r, this.g, this.b), this.__state.hex;
        },
        set: function(e) {
    ...
    var z = function() {
        function e10(t, n) {
            F(this, e10), this.initialValue = t[n], this.domElement = document.createElement("div"), this.object = t, this.property = n, this.__onChange = void 0, this.__onFinishChange = void 0;
        }
        return P(e10, [
            {
                key: "onChange",
    ...
    S.each(M, function(e11, t) {
        S.each(e11, function(e) {
            G[e] = t;
        });
    });
    var U = /(\d+(\.\d+)?)px/, X = {
        ...
        getWidth: function(e) {
            ...
            return i1(t["border-left-width"]) + i1(t["border-right-width"]) + i1(t["padding-left"]) + i1(t["padding-right"]) + i1(t.width);
        },
        getHeight: function(e) {
            var t = getComputedStyle(e);
            return i1(t["border-top-width"]) + i1(t["border-bottom-width"]) + i1(t["padding-top"]) + i1(t["padding-bottom"]) + i1(t.height);
        },
        getOffset: function(e) {
            ...
            if (t.offsetParent) do n.left += t.offsetLeft, n.top += t.offsetTop, t = t.offsetParent;
            while (t);
            return n;
        },
        isActive: function(e) {
        ...
        function t6(e14, n4, o) {
            F(this, t6);
            var i = V(this, (t6.__proto__ || Object.getPrototypeOf(t6)).call(this, e14, n4)), r = o, s = i;
        ...
        return D(t6, z), P(t6, [
            {
                key: "setValue",
                value: function(e) {
                    var n = j(t6.prototype.__proto__ || Object.getPrototypeOf(t6.prototype), "setValue", this).call(this, e);
            ...
            },
            {
                key: "updateDisplay",
                value: function() {
                    return X.isActive(this.__select) ? this : (this.__select.value = this.getValue(), j(t6.prototype.__proto__ || Object.getPrototypeOf(t6.prototype), "updateDisplay", this).call(this));
                }
            }
        ]), t6;
    }(), J = function(e15) {
        function t(e16, n) {
            ...
            F(this, t);
            var i = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e16, n)), r = i;
        ...
        function t(e, n, o) {
            ...
            return i.__min = s.min, i.__max = s.max, i.__step = s.step, S.isUndefined(i.__step) ? 0 === i.initialValue ? i.__impliedStep = 1 : i.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(i.initialValue)) / Math.LN10)) / 10 : i.__impliedStep = i.__step, i.__precision = r1(i.__impliedStep), i;
        }
        return D(t, z), P(t, [
            {
                key: "setValue",
            ...
            },
            {
                key: "step",
                value: function(e) {
                    return this.__step = e, this.__impliedStep = e, this.__precision = r1(e), this;
                }
            }
        ]), t;
    }(), Q = function(e18) {
        function t7(e19, n, o) {
            ...
            F(this, t7);
            var a = V(this, (t7.__proto__ || Object.getPrototypeOf(t7)).call(this, e19, n, o));
        ...
        return D(t7, W), P(t7, [
            {
                key: "updateDisplay",
                value: function() {
                    return this.__input.value = this.__truncationSuspended ? this.getValue() : s1(this.getValue(), this.__precision), j(t7.prototype.__proto__ || Object.getPrototypeOf(t7.prototype), "updateDisplay", this).call(this);
                }
            }
        ]), t7;
    }(), q = function(e20) {
        function t8(e21, n5, o, i, r) {
            function s(e) {
                e.preventDefault();
                var t = _.__background.getBoundingClientRect();
                return _.setValue(a1(e.clientX, t.left, t.right, _.__min, _.__max)), !1;
            }
            function l() {
            ...
            function d(e) {
                ...
                _.setValue(a1(t, n.left, n.right, _.__min, _.__max));
            }
            function c() {
                X.unbind(window, "touchmove", d), X.unbind(window, "touchend", c), _.__onFinishChange && _.__onFinishChange.call(_, _.getValue());
            }
            F(this, t8);
            var u = V(this, (t8.__proto__ || Object.getPrototypeOf(t8)).call(this, e21, n5, {
                min: o,
                max: i,
                step: r
            })), _ = u;
        ...
        return D(t8, W), P(t8, [
            {
                ...
                value: function() {
                    ...
                    return this.__foreground.style.width = 100 * e + "%", j(t8.prototype.__proto__ || Object.getPrototypeOf(t8.prototype), "updateDisplay", this).call(this);
                }
            }
        ]), t8;
    }(), Z = function(e22) {
        function t(e23, n, o) {
            F(this, t);
            var i = V(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e23, n)), r = i;
        ...
        function t9(e25, n6) {
            function o4(e) {
                u(e), X.bind(window, "mousemove", u), X.bind(window, "touchmove", u), X.bind(window, "mouseup", r2), X.bind(window, "touchend", r2);
            }
            function i3(e) {
                _(e), X.bind(window, "mousemove", _), X.bind(window, "touchmove", _), X.bind(window, "mouseup", s2), X.bind(window, "touchend", s2);
            }
            function r2() {
                X.unbind(window, "mousemove", u), X.unbind(window, "touchmove", u), X.unbind(window, "mouseup", r2), X.unbind(window, "touchend", r2), c();
            }
            function s2() {
                X.unbind(window, "mousemove", _), X.unbind(window, "touchmove", _), X.unbind(window, "mouseup", s2), X.unbind(window, "touchend", s2), c();
            }
            function a() {
                var e = R(this.value);
            ...
            F(this, t9);
            var h = V(this, (t9.__proto__ || Object.getPrototypeOf(t9)).call(this, e25, n6));
            ...
            return S.extend(h.__selector.style, {
                ...
                height: "100%",
                background: "none"
            }), l1(f, "top", "rgba(0,0,0,0)", "#000"), S.extend(h.__hue_field.style, {
                width: "15px",
                height: "100px",
                border: "1px solid #555",
                cursor: "ns-resize",
                ...
                top: "3px",
                right: "3px"
            }), d1(h.__hue_field), S.extend(h.__input.style, {
                outline: "none",
                textAlign: "center",
                color: "#fff",
                border: 0,
            ...
            }), X.bind(h.__saturation_field, "mousedown", o4), X.bind(h.__saturation_field, "touchstart", o4), X.bind(h.__field_knob, "mousedown", o4), X.bind(h.__field_knob, "touchstart", o4), X.bind(h.__hue_field, "mousedown", i3), X.bind(h.__hue_field, "touchstart", i3), h.__saturation_field.appendChild(f), h.__selector.appendChild(h.__field_knob), h.__selector.appendChild(h.__saturation_field), h.__selector.appendChild(h.__hue_field), h.__hue_field.appendChild(h.__hue_knob), h.domElement.appendChild(h.__input), h.domElement.appendChild(h.__selector), h.updateDisplay(), h;
        }
        return D(t9, z), P(t9, [
            {
                key: "updateDisplay",
                value: function() {
                    ...
                    var n7 = this.__color.v < .5 || this.__color.s > .5 ? 255 : 0, o = 255 - n7;
                    S.extend(this.__field_knob.style, {
                        marginLeft: 100 * this.__color.s - 7 + "px",
                        marginTop: 100 * (1 - this.__color.v) - 7 + "px",
                        backgroundColor: this.__temp.toHexString(),
                        border: this.__field_knob_border + "rgb(" + n7 + "," + n7 + "," + n7 + ")"
                    }), this.__hue_knob.style.marginTop = 100 * (1 - this.__color.h / 360) + "px", this.__temp.s = 1, this.__temp.v = 1, l1(this.__saturation_field, "left", "#fff", this.__temp.toHexString()), this.__input.value = this.__color.toString(), S.extend(this.__input.style, {
        ...
        function e27() {
            F(this, e27), this.backgroundElement = document.createElement("div"), S.extend(this.backgroundElement.style, {
        ...
        return P(e27, [
            ...
            },
            {
                ...
                value: function() {
                    ...
                    X.bind(this.domElement, "webkitTransitionEnd", t10), X.bind(this.domElement, "transitionend", t10), X.bind(this.domElement, "oTransitionEnd", t10), this.backgroundElement.style.opacity = 0, this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)";
                }
            },
            {
                key: "layout",
    ...
    var se = "Default", ae = function() {
    ...
    }(), le = void 0, de = !0, ce = void 0, ue = !1, _e = [], he = function e28(t11) {
        var n = this, o = t11 || {};
        ...
        if (Object.defineProperties(this, {
            ...
            closed: {
                ...
                set: function(t) {
                    o.closed = t, o.closed ? X.addClass(n.__ul, e28.CLASS_CLOSED) : X.removeClass(n.__ul, e28.CLASS_CLOSED), this.onResize(), n.__closeButton && (n.__closeButton.innerHTML = t ? e28.TEXT_OPEN : e28.TEXT_CLOSED);
                }
            },
            load: {
                get: function() {
            ...
            if (this.closed = o.closed || !1, X.addClass(this.domElement, e28.CLASS_MAIN), X.makeSelectable(this.domElement, !1), ae && i) {
                n.useLocalStorage = !0;
                var a = localStorage.getItem(m(this, "gui"));
                a && (o.load = JSON.parse(a));
            }
            this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = e28.TEXT_CLOSED, X.addClass(this.__closeButton, e28.CLASS_CLOSE_BUTTON), o.closeOnTop ? (X.addClass(this.__closeButton, e28.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (X.addClass(this.__closeButton, e28.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)), X.bind(this.__closeButton, "click", function() {
                n.closed = !n.closed;
            });
        } else {
            void 0 === o.closed && (o.closed = !0);
            var l = document.createTextNode(o.name);
            X.addClass(l, "controller-name"), s = c1(n, l);
            X.addClass(this.__ul, e28.CLASS_CLOSED), X.addClass(s, "title"), X.bind(s, "click", function(e) {
                return e.preventDefault(), n.closed = !n.closed, !1;
            }), o.closed || (this.closed = !1);
        }
        o.autoPlace && (S.isUndefined(o.parent) && (de && (ce = document.createElement("div"), X.addClass(ce, "dg"), X.addClass(ce, e28.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(ce), de = !1), ce.appendChild(this.domElement), X.addClass(this.domElement, e28.CLASS_AUTO_PLACE)), this.parent || w(n, o.width)), this.__resizeHandler = function() {
            n.onResizeDebounced();
    ...
    he.toggleHide = function() {
        ...
        destroy: function() {
            ...
            S.each(this.__folders, function(t) {
                e.removeFolder(t);
            }), X.unbind(window, "keydown", he._keydownHandler, !1), u1(this);
        },
        addFolder: function(e) {
            ...
            var n = new he(t);
            this.__folders[e] = n;
            var o = c1(this, n.domElement);
            return X.addClass(o, "folder"), n;
        },
        removeFolder: function(e) {
            this.__ul.removeChild(e.domElement.parentElement), delete this.__folders[e.name], this.load && this.load.folders && this.load.folders[e.name] && delete this.load.folders[e.name], u1(e);
            var t12 = this;
        ...
        onResize: function() {
            var e = this.getRoot();
            if (e.scrollable) {
                var t13 = X.getOffset(e.__ul).top, n = 0;
                S.each(e.__ul.childNodes, function(t) {
                    e.autoPlace && t === e.__save_row || (n += X.getHeight(t));
                }), window.innerHeight - t13 - 20 < n ? (X.addClass(e.domElement, he.CLASS_TOO_TALL), e.__ul.style.height = window.innerHeight - t13 - 20 + "px") : (X.removeClass(e.domElement, he.CLASS_TOO_TALL), e.__ul.style.height = "auto");
            }
        ...
        save: function() {
            this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = x(this), _1(this, !1), this.saveToLocalStorageIfPossible();
        },
        saveAs: function(e) {
        ...
        revert: function(e29) {
            S.each(this.__controllers, function(t) {
                this.getRoot().load.remembered ? p1(e29 || this.getRoot(), t) : t.setValue(t.initialValue), t.__onFinishChange && t.__onFinishChange.call(t, t.getValue());
            }, this), S.each(this.__folders, function(e) {
                e.revert(e);
            }), e29 || _1(this.getRoot(), !1);
        },
        listen: function(e) {
    ...
    e1.color = pe, e1.controllers = fe, e1.dom = me, e1.gui = ge, e1.GUI = be, e1.default = ve, Object.defineProperty(e1, "__esModule", {
        value: !0
    });
});

//# sourceMappingURL=team.e0ef7e6c.js.map
